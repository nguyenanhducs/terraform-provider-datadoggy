		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("datadoggo_notebook.test", "id"),
					resource.TestCheckResourceAttr("datadoggo_notebook.test", "name", "Test Notebook Basic"),
					resource.TestCheckResourceAttr("datadoggo_notebook.test", "type", "runbook"),
				),
			},
			{
...
resource "datadoggo_notebook" "test" {
  name = %q
  type = "runbook"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("datadoggo_notebook.test", "id"),
					resource.TestCheckResourceAttr("datadoggo_notebook.test", "teams.#", "1"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("datadoggo_notebook.test", "id"),
					resource.TestCheckResourceAttr("datadoggo_notebook.test", "teams.#", "2"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("datadoggo_notebook.test", "id"),
					resource.TestCheckResourceAttr("datadoggo_notebook.test", "template_variables.#", "1"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("datadoggo_notebook.test", "id"),
					resource.TestCheckResourceAttr("datadoggo_notebook.test", "template_variables.#", "2"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("datadoggo_notebook.test", "id"),
					resource.TestCheckResourceAttr("datadoggo_notebook.test", "time.live_span", "1h"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("datadoggo_notebook.test", "id"),
					resource.TestCheckResourceAttr("datadoggo_notebook.test", "time.live_span", "4h"),
				),
			},
		},
	})
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("datadoggo_notebook.test", "id"),
					resource.TestCheckResourceAttr("datadoggo_notebook.test", "type", "postmortem"),
				),
			},
		},
	})
